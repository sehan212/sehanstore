...
const instagram = 'https://instagram.com/gih.seh'; 
const telegram = 'https://t.me/sehannya3'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@gih.seh')
